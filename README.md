# genpark-git-native-multi-file-refactor-pair-programmer-skill
...
> **GenPark AI Agent Skill** -- Git-native multi-file pair programmer & tree-sitter refactor executor (Aider style)
